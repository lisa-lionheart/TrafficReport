...
namespace TrafficReport
{
	public class PathMeshBuilder {
		...
		public void AddPoints(Vector3[] points){
			...
			AddEndStop (points[0], (points[1]-points[0]).normalized, false);

			Vector3 endFwd = (points [points.Length - 1] - points [points.Length - 3]).normalized;
			AddEndStop (points[points.Length-1], endFwd, true);
		}
