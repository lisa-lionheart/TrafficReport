...
public class Test : MonoBehaviour {
	...
	void Start () {
        ...
        canvas.re RectTransform.width = 1920;
        canvas.RectTransform.height = 1080;



        //go.AddComponent<Canvas>();
       // go.AddComponent<QueryToolGUIBase> ();

        //material = ResourceLoader.bundle.Load("Materials/Line") as Material;
